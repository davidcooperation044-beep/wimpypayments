...
This repository contains two standalone services that can run independently while sharing one Supabase project.
...
1. Copy the example environment files for both services and fill in your Supabase and payment values.
